...
class cartMachine extends StatelessWidget {
   cartMachine({Key? key}) : super(key: key);
  final Future<List<Map<dynamic, dynamic>>?> machines = store().getNewMachine();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('cart Machine')),
      ),
      drawer: Drawer(
        child: drawerview(),
      ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => MyCart(machineId: machineIds)),
                      );
